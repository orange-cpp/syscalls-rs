//! OS-level constants, structs, and helpers.
//!
//! On Windows, most public symbols are re-exports of `windows-sys` types.
//! On Linux, minimal definitions for mmap/mprotect constants.
...
mod windows_defs {
    ...
    pub use windows_sys::Win32::System::Diagnostics::Debug::{
        IMAGE_NT_HEADERS32, IMAGE_NT_HEADERS64, IMAGE_RUNTIME_FUNCTION_ENTRY, IMAGE_SECTION_HEADER,
    };
